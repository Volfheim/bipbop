...
/* package github.com/volfheim/bipbop/mobile/golib */
...
extern jint Java_com_volfheim_bipbop_BipBopVpnService_startVpnNative(JNIEnv* env, jobject service, jstring smartKey, jint tunFd, jint mtu, jstring dns);
extern void Java_com_volfheim_bipbop_BipBopVpnService_reconnectVpnNative(JNIEnv* env, jobject service);
extern void Java_com_volfheim_bipbop_BipBopVpnService_stopVpnNative(JNIEnv* env, jobject service);
